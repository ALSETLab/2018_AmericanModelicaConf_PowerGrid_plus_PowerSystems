within OpenCPS_D53B.MultiDomain.SMIB.OpenLoopTests.NoiseOnLoad;
model SMIB_TM "Open-Loop Test of the Single-Shaft Gas Turbine Model driving generator of the SMIB network"
  ...
  PowerSystemDomain.Networks.SMIB.Records.PF_030 pf_results annotation (Placement(transformation(extent={{-136,50},{-116,70}})));
equation
