...
model Turbine "GE General GGOV Turbine Model"
  ...
  Modelica.Blocks.Math.Gain gain2(k=Dm) annotation (Placement(transformation(
        ...
        rotation=0,
        origin={22,102})));
  OpenIPSL.Electrical.Controls.PSSE.TG.GGOV1.flag flag10(flag=Flag) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=90,
        origin={18,-106})));
  OpenIPSL.Electrical.Controls.PSSE.TG.GGOV1.Dm_select dm_select(Dm=Dm) annotation (Placement(transformation(extent={{-16,92},{4,112}})));
