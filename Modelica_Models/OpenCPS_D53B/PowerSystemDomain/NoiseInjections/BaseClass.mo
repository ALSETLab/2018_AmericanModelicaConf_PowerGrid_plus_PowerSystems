...
partial model BaseClass
  ...
  Modelica.Blocks.Noise.NormalNoise noise_gen(
    ...
    sigma=active_sigma) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=0)));
  Modelica.Blocks.Interfaces.RealOutput y annotation (Placement(transformation(extent={{40,0},{64,24}}), iconTransformation(extent={{96,-14},{122,12}})));
  annotation (Icon(graphics={Ellipse(
          ...
          endAngle=360), Line(
          origin={30,0},
          points={{-100,0},{-80,0},{-70,40},{-60,-20},{-50,20},{-28,-40},{-10,40},{0,-20},{12,20},{20,0},{40,0},{40,0}},
          thickness=2)}));
end BaseClass;
