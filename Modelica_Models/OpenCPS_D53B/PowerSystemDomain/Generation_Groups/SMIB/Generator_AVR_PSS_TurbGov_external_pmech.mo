...
equation
  ...
  connect(add.y, govturb.PELEC) annotation (Line(points={{-97,46},{-89.5,46},{
          -89.5,49.8571},{-81.125,49.8571}}, color={0,0,127}));
  connect(add.u2, pss.V_S2) annotation (Line(points={{-120,40},{-88,40},{-88,
          -44},{20,-44},{20,-46},{60,-46}}, color={0,0,127}));
  connect(u, add.u1)
