...
partial model SMIB_Partial_Noise_normal_limhit
  ...
  inner OpenIPSL.Electrical.SystemBase SysData(S_b=10, fn=50) annotation (Placement(transformation(extent={{66,-100},
            {120,-80}})));
protected
...
public
  ...
  Loads.VariableLoad variableLoad(
    ...
    d_t=0,
    d_P=0,
    characteristic=2) annotation (Placement(transformation(extent={{26,-94},{46,
            -76}})));
