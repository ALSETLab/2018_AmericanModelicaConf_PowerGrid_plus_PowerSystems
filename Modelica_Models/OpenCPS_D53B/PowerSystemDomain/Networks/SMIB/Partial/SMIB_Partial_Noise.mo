...
partial model SMIB_Partial_Noise "Partial model containing the network elements, GENROU generator, stochastic load"
  ...
  inner OpenIPSL.Electrical.SystemBase SysData(S_b=10, fn=50) annotation (Placement(transformation(extent={{-136,76},{-82,96}})));
protected
...
public
  ...
  NoiseInjections.SineNoiseInjection sineNoiseInjection(
    active_sigma=0.0001,
    freqHz=10,
    amplitude=0) annotation (Placement(transformation(extent={{0,-94},{20,-74}})));
