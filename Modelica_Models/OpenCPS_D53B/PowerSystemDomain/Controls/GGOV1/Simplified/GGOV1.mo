...
equation
  ...
  connect(turb.FSR, V.y) annotation (Line(points={{133.643,-11.6429},{108,-11.6429},{108,-7},{97.3,-7}}, color={0,0,127}));
  connect(turb.TEXM, gGOV1_Temp.TEXM) annotation (Line(points={{166,42.5714},{166,42.5714},{166,70},{166,85},{-77.6,85}}, color={0,0,127}));
  ...
  connect(P_ref.y, gGOV1_Power.P_REF) annotation (Line(points={{-210.9,-91},{-198,-91},{-198,-110.214},{-142.357,-110.214}}, color={0,0,127}));
  ...
  connect(gGOV1_Power.SPEED, SPEED) annotation (Line(points={{-142.357,-92.6429},{-180,-92.6429},{-180,-34},{-240,-34},{-240,17},{-283,17}}, color={0,0,127}));
  connect(turb.SPEED, SPEED) annotation (Line(points={{133.857,31.4286},{100,31.4286},{100,140},{-240,140},{-240,17},{-283,17}}, color={0,0,127}));
  connect(gGOV1_Power.PELEC, PELEC) annotation (Line(points={{-142.357,-127.357},{-182,-127.357},{-182,-168},{-256,-168},{-256,-54},{-302,-54}}, color={0,0,127}));
  ...
  connect(turb.PELEC, PELEC) annotation (Line(points={{134.071,10.2143},{120,10.2143},{120,-200},{-274,-200},{-274,-54},{-302,-54}}, color={0,0,127}));
  connect(turb.PMECH, PMECH) annotation (Line(points={{198.571,10},{214,10},{214,35},{241,35}}, color={0,0,127}));
