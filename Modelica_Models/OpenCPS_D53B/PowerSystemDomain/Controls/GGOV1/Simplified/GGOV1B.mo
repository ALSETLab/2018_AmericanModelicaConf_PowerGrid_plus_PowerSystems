...
equation
  ...
  connect(SPEED, gov.SPEED) annotation (Line(points={{-127,15},{-105.5,15},{-105.5,14.7857},{-82.3571,14.7857}}, color={0,0,127}));
  connect(turb.SPEED, gov.SPEED) annotation (Line(points={{37.8571,21.4286},{0,21.4286},{0,60},{-100,60},{-100,14.7857},{-82.3571,14.7857}}, color={0,0,127}));
  connect(PELEC, gov.PELEC) annotation (Line(points={{-128,-14},{-82.3571,-14},{-82.3571,-14.7857}}, color={0,0,127}));
  connect(turb.PELEC, gov.PELEC) annotation (Line(points={{38.0714,0.214286},{20,0.214286},{20,-60},{-100,-60},{-100,-14},{-82.3571,-14},{-82.3571,-14.7857}}, color={0,0,127}));
