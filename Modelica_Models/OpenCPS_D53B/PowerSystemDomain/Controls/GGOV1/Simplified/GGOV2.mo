...
equation
  ...
  connect(SPEED, gov.SPEED) annotation (Line(points={{-127,15},{-105.5,15},{-105.5,17.3571},{-82.3571,17.3571}}, color={0,0,127}));
  ...
  connect(PELEC, gov.PELEC) annotation (Line(points={{-128,-14},{-82.3571,-14},{-82.3571,-17.3571}}, color={0,0,127}));
  connect(turb.PELEC, gov.PELEC) annotation (Line(points={{38.0714,0.214286},{20,0.214286},{20,-60},{-100,-60},{-100,-14},{-82.3571,-14},{-82.3571,-17.3571}}, color={0,0,127}));
